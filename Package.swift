...
if ProcessInfo.processInfo.environment["YSWIFT_LOCAL"] != nil {
    ...
    FFIbinaryTarget = .binaryTarget(
            name: "yniffiFFI",
            url: "https://github.com/siuying/yswift/releases/download/0.2.1c/yniffiFFI.xcframework.zip",
            checksum: "9f852e952f0bd301d29896b1bcdaa62948d4a31cf34c595315d7f3ab3981eebb"
    )
}
